...
import molecules_filters.lipinski as lp
import os
import random
import argparse
...
def double_joiner(scaffold_smi, decorations):
    ...
    In this fuction, a lipinski's-rules-filter had added into from 'lipinski.py',
    molecules don't obey the rules won't be written to the final file.
    '''
