...
if __name__ == "__main__":
    scaffold_smi='CC=CC([*:1])N1CCN(c2cccc(Cl)c2)CC1'
    decoration_smi='[*]N1C(=O)c2c(cccc2)C1=O'
    print(rkc.MolToSmiles(join_joined_attachments(scaffold_smi,decoration_smi)))